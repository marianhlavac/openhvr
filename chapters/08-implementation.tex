...
\hypertarget{x-device-drivers}{\subsubsection*{Device drivers}}
...
\begin{figure}[h]{}
\centering\includegraphics[width=2.5truein]{assets/drivers-diagram.pdf}
\caption{}
...
\hypertarget{x-unity-plug-in}{\subsection*{Unity Plug-in}}
...
\begin{figure}[h]{}
\centering\includegraphics[width=2.5truein]{assets/icon-series.png}
\caption{}
...
\hypertarget{x-esp-01s-relay-boards}{\subsubsection*{ESP-01S relay boards}}
...
\begin{figure}[h]{}
\centering\includegraphics[width=2.5truein]{assets/IMG_5236.jpeg}
\caption{}
...
\begin{figure}[h]{}
\centering\includegraphics[width=2.5truein]{assets/running-server.png}
\caption{}

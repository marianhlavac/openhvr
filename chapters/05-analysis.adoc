...
.3D Audio source set in a Unity Engine scene. The speaker icon defines the source location of the sound, and the blue sphere defines the strength (range) of the 3D sound. NAHRADIT VLASTNIM
